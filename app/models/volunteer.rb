class Volunteer < ApplicationRecord
  ...
  def self.past_rallys
    %w(sno_drift 100_acre_wood oregon_trail_rally olympus_rally stpr nefr ojibwe lspr rally_colorado show_me_rally sno_drift_summer nemadji_winter_rally)
  end
end
